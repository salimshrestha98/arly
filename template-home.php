...
<!-- slider section -->
	...
	<div class="owl-carousel portfolio_carousel">
		...
		<div class="box">
			<div class="img-box">
			<img src="<?php echo bloginfo( 'template_directory' ); ?>/images/p1.jpg" alt="" />
		...
		<div class="box">
			<div class="img-box">
			<img src="<?php echo bloginfo( 'template_directory' ); ?>/images/p2.jpg" alt="" />
			<div class="btn_overlay">
				<a href="" class="">
				See More
				</a>
		...
		<div class="box">
			<div class="img-box">
			<img src="<?php echo bloginfo( 'template_directory' ); ?>/images/p3.jpg" alt="" />
			<div class="btn_overlay">
				<a href="" class="">
				See More
				</a>
	...
	<div class="container ">
		...
		<div class="col-sm-6 col-md-4">
			<div class="box ">
			<div class="img-box">
				<img src="<?php echo bloginfo( 'template_directory' ); ?>/images/s4.png" alt="" />
			</div>
			<div class="detail-box">
				<h5>
				Machine Welding
		...
		<div class="col-sm-6 col-md-4">
			<div class="box ">
			<div class="img-box">
				<img src="<?php echo bloginfo( 'template_directory' ); ?>/images/s5.png" alt="" />
			</div>
			<div class="detail-box">
				<h5>
				Bike Welding
		...
		<div class="col-sm-6 col-md-4">
			<div class="box ">
			<div class="img-box">
				<img src="<?php echo bloginfo( 'template_directory' ); ?>/images/s6.png" alt="" />
			</div>
			<div class="detail-box">
				<h5>
				Car Welding
			...
			<div class="row">
				...
				<div class="carousel-inner">
					...
					<div class="box">
						<div class="client_id">
						<div class="img-box">
							<img src="<?php echo bloginfo( 'template_directory' ); ?>/images/client.jpg" alt="" />
						</div>
						<h5>
							Alex Jonson
						</h5>
